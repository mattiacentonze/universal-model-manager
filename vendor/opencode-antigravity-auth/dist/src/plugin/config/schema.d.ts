...
export declare const AntigravityConfigSchema: z.ZodObject<{
    ...
    thinking_warmup: z.ZodDefault<z.ZodBoolean>;
    cache_warmup_on_switch: z.ZodDefault<z.ZodBoolean>;
    ...
    max_account_switches: z.ZodDefault<z.ZodNumber>;
    quota_style_fallback: z.ZodDefault<z.ZodBoolean>;
    ...
    switch_account_delay_ms: z.ZodDefault<z.ZodNumber>;
    ...
    proactive_rotation_threshold_percent: z.ZodDefault<z.ZodNumber>;
    ...
    background_quota_refresh: z.ZodDefault<z.ZodBoolean>;
    background_quota_refresh_interval_minutes: z.ZodDefault<z.ZodNumber>;
    ...
    operator: z.ZodOptional<z.ZodObject<{
        ...
        killswitch: z.ZodOptional<z.ZodObject<{
            enabled: z.ZodDefault<z.ZodBoolean>;
            minimum_remaining_percent: z.ZodDefault<z.ZodNumber>;
