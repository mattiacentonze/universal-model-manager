 ...
 */
export declare function createSyntheticTextResponse(text: string, extraHeaders?: Record<string, string>): Response;
export declare function createSyntheticErrorResponse(errorMessage: string, _requestedModel?: string): Response;
