...
import { findMessageByIndexNeedingThinking, findMessagesWithOrphanThinking, findMessagesWithThinkingBlocks, prependThinkingPart, readParts, stripThinkingParts, } from './recovery/storage';
// =============================================================================
// Constants
// =============================================================================
...
export function detectErrorType(error) {
    const message = getErrorMessage(error);
    const hasExpectedFoundThinkingOrder = (message.includes('expected thinking') ||
