...
export declare function calculateBackoffMs(reason: RateLimitReason, consecutiveFailures: number, retryAfterMs?: number | null, random?: () => number): number;
...
export declare class HealthScoreTracker {
    ...
    constructor(config?: Partial<HealthScoreConfig>, now?: () => number);
    /**
 ...
 */
export declare function addJitter(baseMs: number, jitterFactor?: number, random?: () => number): number;
/**
 ...
 */
export declare function randomDelay(minMs: number, maxMs: number, random?: () => number): number;
 ...
 */
export declare function selectHybridAccount(accounts: AccountWithMetrics[], tokenTracker: TokenBucketTracker, currentAccountIndex?: number | null, minHealthScore?: number, now?: () => number): number | null;
...
export declare class TokenBucketTracker {
    ...
    private readonly config;
    private readonly now;
    constructor(config?: Partial<TokenBucketConfig>, now?: () => number);
    /**
