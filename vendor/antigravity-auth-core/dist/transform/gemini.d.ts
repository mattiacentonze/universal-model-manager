 ...
 */
import type { GoogleSearchConfig, RequestPayload, ThinkingConfig, ThinkingTier } from './types.ts';
...
export declare function toGeminiSchema(schema: unknown, options?: GeminiSchemaOptions): unknown;
/**
 ...
 */
export declare function normalizeGeminiTools(payload: RequestPayload, schemaOptions?: GeminiSchemaOptions): {
