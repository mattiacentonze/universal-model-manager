...
export function toGeminiSchema(schema, options = {}) {
    ...
    for (const [key, value] of Object.entries(inputSchema)) {
        ...
        else if (options.moveNumericConstraintsToDescription &&
 ...
 */
export function normalizeGeminiTools(payload, schemaOptions = {}) {
