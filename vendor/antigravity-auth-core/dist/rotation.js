...
export function calculateBackoffMs(reason, consecutiveFailures, retryAfterMs, random = Math.random) {
 ...
 */
export function addJitter(baseMs, jitterFactor = 0.3, random = Math.random) {
 ...
 */
export function selectHybridAccount(accounts, tokenTracker, currentAccountIndex = null, minHealthScore = 50, now = Date.now) {
